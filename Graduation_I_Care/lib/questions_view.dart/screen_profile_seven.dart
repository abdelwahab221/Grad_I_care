...
class ScreenOfProfileSeven extends StatefulWidget {
  const ScreenOfProfileSeven({super.key});

  @override
  State<ScreenOfProfileSeven> createState() => _ScreenOfProfileSevenState();
}

class _ScreenOfProfileSevenState extends State<ScreenOfProfileSeven> {
  @override
              ...
              children: [
                    ...
                    children: [
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "To know your phone in emergency",
                            style: SafeGoogleFont("Work Sans",
                                fontSize: 14,
                                fontWeight: FontWeight.w400,
                      ...
                      Row(
                        ...
                        children: [
                          ...
                          Text(
                            "To call them in case of emergency",
                            style: SafeGoogleFont("Work Sans",
                                fontSize: 14,
                                fontWeight: FontWeight.w400,
                                color: const Color.fromARGB(196, 9, 10, 22)),
                ...
                Container(
                  ...
                  child: MaterialButton(
                    onPressed: () {
                      Navigator.push( context, MaterialPageRoute(builder: (context) => const ScreenOfProfileEight()),);
                    },
                    child: Text(
                      "Continue",
                      style: SafeGoogleFont("Work Sans",
